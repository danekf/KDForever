...
export class ContactUsComponent implements OnInit {
  ...
  faqs: FAQ = [
    ...
    {question:'Is parking available at the venue?', answer:'Parking is available on site at the venue. Cars left at Venue must be recovered by 10AM the following day.'},
