...
export class ContactUsComponent implements OnInit {
  ...
  faqs: FAQ = [
    ...
    {question:'Is parking available at the location?', answer:'Parking is available on site, though the venue does charge if the vehicle needs to be left overnight.'},
