...
export class ContactUsComponent implements OnInit {
  ...
  faqs: FAQ = [
    ...
    {question:'Will transportation be provided?', answer:'We are currently looking into group transportation to/from a chosen hotel for the wedding. More information will be provided closer to the date.'},
    {question:'', answer:''},
